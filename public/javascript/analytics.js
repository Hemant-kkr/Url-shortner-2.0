...
const countryData = JSON.parse(countryStats.dataset.analytics);
...
const cityData = JSON.parse(cityStats.dataset.analytics);
...
const deviceData = JSON.parse(deviceStats.dataset.analytics);
...
const browserAnalytics = document.getElementById("browserStats");
const browserData = JSON.parse(browserAnalytics.dataset.analytics);
